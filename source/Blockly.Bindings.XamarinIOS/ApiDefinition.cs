...
namespace Blockly.Bindings.XamarinIOS
{
    ...
    interface BKYMutatorIfElse_Blockly_Swift_4990
    {
        ...
        // -(BKYAEXMLElement * _Nonnull)toXMLElement __attribute__((warn_unused_result));
        [Static]
        [Export("toXMLElement")]
        BKYAEXMLElement ToXMLElement { get; }

        // -(void)updateFromXML:(BKYAEXMLElement * _Nonnull)xml;
        [Export("updateFromXML:")]
        void UpdateFromXML(BKYAEXMLElement xml);
    }
    ...
    interface BKYMutatorLayout
    {
        ...
        [Export("performMutationFromXML:error:")]
        bool PerformMutationFromXML(BKYAEXMLElement xml, [NullAllowed] out NSError error);
    }
    ...
    interface BKYNumberPad : IUITextFieldDelegate
    {
        ...
        BKYNumberPadTextField TextField { get; set; }
    ...
    [BaseType(typeof(UITextField))]
    interface BKYNumberPadTextField
    {
    ...
    interface BKYToolbox_Blockly_Swift_5776
    {
        ...
        // +(BKYToolbox * _Nullable)makeToolboxWithXml:(BKYAEXMLElement * _Nonnull)xml factory:(BKYBlockFactory * _Nonnull)factory error:(NSError * _Nullable * _Nullable)error __attribute__((warn_unused_result));
        [Static]
        [Export("makeToolboxWithXml:factory:error:")]
        [return: NullAllowed]
        BKYToolbox MakeToolboxWithXml(BKYAEXMLElement xml, BKYBlockFactory factory, [NullAllowed] out NSError error);
    }
    ...
    interface BKYViewBuilder : BKYLayoutHierarchyListener
    {
        ...
        //[Export ("layout:didAdoptChildLayout:fromOldParentLayout:")]
        //void LayoutDidAdoptChildLayout (BKYLayout layout, BKYLayout childLayout, [NullAllowed] BKYLayout oldParentLayout);

        //// -(void)layout:(BKYLayout * _Nonnull)layout didRemoveChildLayout:(BKYLayout * _Nonnull)childLayout;
        //[Export ("layout:didRemoveChildLayout:")]
        //void LayoutDidRemoveChildLayout (BKYLayout layout, BKYLayout childLayout);
    }
    ...
    interface BKYWorkspace_Blockly_Swift_6611
    {
        ...
        [Export("loadBlocksFromXML:factory:error:")]
        bool LoadBlocksFromXML(BKYAEXMLElement xml, BKYBlockFactory factory, [NullAllowed] out NSError error);
    }
    ...
    [BaseType(typeof(NSObject))]
    [DisableDefaultCtor]
    interface BKYAEXMLElement
    {
        // @property (readonly, nonatomic, weak) BKYAEXMLElement * _Nullable parent;
        [NullAllowed, Export("parent", ArgumentSemantic.Weak)]
        BKYAEXMLElement Parent { get; }

        // @property (readonly, copy, nonatomic) NSArray<BKYAEXMLElement *> * _Nonnull children;
        [Export("children", ArgumentSemantic.Copy)]
        BKYAEXMLElement[] Children { get; }
        ...
        // @property (readonly, copy, nonatomic) NSString * _Nonnull string;
        [Export("string")]
        string String { get; }

        // @property (readonly, getter = _Bool, nonatomic) BOOL bool_;
        [Export("bool_")]
        bool Bool_ { [Bind("_Bool")] get; }

        // @property (readonly, getter = int, nonatomic) NSInteger int_;
        [Export("int_")]
        nint Int_ { [Bind("int")] get; }

        // @property (readonly, getter = double, nonatomic) double double_;
        [Export("double_")]
        double Double_ { [Bind("double")] get; }

        // -(instancetype _Nonnull)initWithName:(NSString * _Nonnull)name value:(NSString * _Nullable)value attributes:(NSDictionary<NSString *,NSString *> * _Nonnull)attributes __attribute__((objc_designated_initializer));
        [Export("initWithName:value:attributes:")]
        [DesignatedInitializer]
        IntPtr Constructor(string name, [NullAllowed] string value, NSDictionary<NSString, NSString> attributes);

        // -(BKYAEXMLElement * _Nonnull)objectForKeyedSubscript:(NSString * _Nonnull)key __attribute__((warn_unused_result));
        [Export("objectForKeyedSubscript:")]
        BKYAEXMLElement ObjectForKeyedSubscript(string key);

        // @property (readonly, copy, nonatomic) NSArray<BKYAEXMLElement *> * _Nullable all;
        [NullAllowed, Export("all", ArgumentSemantic.Copy)]
        BKYAEXMLElement[] All { get; }

        // @property (readonly, nonatomic, strong) BKYAEXMLElement * _Nullable first;
        [NullAllowed, Export("first", ArgumentSemantic.Strong)]
        BKYAEXMLElement First { get; }

        // @property (readonly, nonatomic, strong) BKYAEXMLElement * _Nullable last;
        [NullAllowed, Export("last", ArgumentSemantic.Strong)]
        BKYAEXMLElement Last { get; }

        // @property (readonly, nonatomic) NSInteger count;
        [Export("count")]
        nint Count { get; }

        // -(NSArray<BKYAEXMLElement *> * _Nullable)allWithValue:(NSString * _Nonnull)value __attribute__((warn_unused_result));
        [Export("allWithValue:")]
        [return: NullAllowed]
        BKYAEXMLElement[] AllWithValue(string value);

        // -(NSArray<BKYAEXMLElement *> * _Nullable)allWithAttributes:(NSDictionary<NSString *,NSString *> * _Nonnull)attributes __attribute__((warn_unused_result));
        [Export("allWithAttributes:")]
        [return: NullAllowed]
        BKYAEXMLElement[] AllWithAttributes(NSDictionary<NSString, NSString> attributes);

        // -(BKYAEXMLElement * _Nonnull)addChild:(BKYAEXMLElement * _Nonnull)child;
        [Export("addChild:")]
        BKYAEXMLElement AddChild(BKYAEXMLElement child);
        ...
        [Export("addChildWithName:value:attributes:")]
        BKYAEXMLElement AddChildWithName(string name, [NullAllowed] string value, NSDictionary<NSString, NSString> attributes);
        ...
        // @property (readonly, copy, nonatomic) NSString * _Nonnull xmlCompact;
        [Export("xmlCompact")]
        string XmlCompact { get; }
    }

    // @interface BKYAEXMLDocument : BKYAEXMLElement
    [BaseType(typeof(BKYAEXMLElement))]
    interface BKYAEXMLDocument
    {
        // @property (readonly, nonatomic, strong) BKYAEXMLElement * _Nonnull root;
        [Export("root", ArgumentSemantic.Strong)]
        BKYAEXMLElement Root { get; }

        // -(BOOL)loadXML:(NSData * _Nonnull)data error:(NSError * _Nullable * _Nullable)error;
        [Export("loadXML:error:")]
        bool LoadXML(NSData data, [NullAllowed] out NSError error);
